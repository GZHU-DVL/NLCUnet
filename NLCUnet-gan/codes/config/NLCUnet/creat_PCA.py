...
parser.add_argument(
    "-opt",
    type=str,
    default="/share/home/104632/jiancong/DAN-unet/codes/config/DANv1/options/setting2/train/train_setting2_x2.yml",
...
torch.save(pca_matrix, "/share/home/104632/jiancong/DAN-unet/pca_matrix/DANv1/{}.pth".format(matrix_name))
print("Save PCA matrix at: /share/home/104632/jiancong/DAN-unet/pca_matrix/DANv1/{}.pth".format(matrix_name))
