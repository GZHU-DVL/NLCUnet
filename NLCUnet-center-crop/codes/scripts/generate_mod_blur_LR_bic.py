...
def generate_mod_LR_bic():
    ...
    mod_scale = 2
    # set data dir
    sourcedir = "/share/home/104632/jiancong/Set5_crop"
    savedir = "/share/home/104632/jiancong/Set5_crop_preprocess_x2"

    # load PCA matrix of enough kernel
    print("load PCA matrix")
    pca_matrix = torch.load(
        "/share/home/104632/jiancong/DAN-global-localx2/pca_matrix/DANv1/pca_matrix.pth", map_location=lambda storage, loc: storage
    )
